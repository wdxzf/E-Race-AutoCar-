...
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
void void_function_ptr_default (void *prt)
{
}
...
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
uint32 uint32_function_ptr_default (void *prt)
{
    return 0;
}
...
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
void *ptr_function_ptr_default (void *prt)
{
    return NULL;
}
...
// 备注信息     
//-------------------------------------------------------------------------------------------------------------------
void void_callback_uint32_ptr_default (uint32 state, void *prt)
{
}
